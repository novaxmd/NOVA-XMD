...
const TTL = 300000;
const _DEFAULTS = { device: 'default', prefix: '.', mode: 'public', gcpresence: false, antitag: false, antidelete: true, antilink: 'off', chatbotpm: false, packname: 'NOVA-XMD', author: 'bmb tech', multiprefix: false, stealth: false, startmessage: true, autoview: false, autoai: false, toxicagent: false, warn_limit: 3, autobio: false, presence: 'off', autoread: false, autolike: true, anticall: false, antiviewonce: false };
